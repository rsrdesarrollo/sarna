...
def upgrade():
    ...
    op.create_table('finding_template',
                    ...
                    sa.Column('owasp_category',
                              sa.Enum('OTG_INFO_001', 'OTG_INFO_002', 'OTG_INFO_003', 'OTG_INFO_004', 'OTG_INFO_005',
                                      'OTG_INFO_006', 'OTG_INFO_007', 'OTG_INFO_008', 'OTG_INFO_009', 'OTG_INFO_010',
                                      'OTG_CONFIG_001', 'OTG_CONFIG_002', 'OTG_CONFIG_003', 'OTG_CONFIG_004',
                                      'OTG_CONFIG_005', 'OTG_CONFIG_006', 'OTG_CONFIG_007', 'OTG_CONFIG_008',
                                      'OTG_IDENT_001', 'OTG_IDENT_002', 'OTG_IDENT_003', 'OTG_IDENT_004',
                                      'OTG_IDENT_005', 'OTG_IDENT_006', 'OTG_IDENT_007', 'OTG_AUTHN_001',
                                      'OTG_AUTHN_002', 'OTG_AUTHN_003', 'OTG_AUTHN_004', 'OTG_AUTHN_005',
                                      'OTG_AUTHN_006', 'OTG_AUTHN_007', 'OTG_AUTHN_008', 'OTG_AUTHN_009',
                                      'OTG_AUTHN_010', 'OTG_AUTHZ_001', 'OTG_AUTHZ_002', 'OTG_AUTHZ_003',
                                      'OTG_AUTHZ_004', 'OTG_SESS_001', 'OTG_SESS_002', 'OTG_SESS_003', 'OTG_SESS_004',
                                      'OTG_SESS_005', 'OTG_SESS_006', 'OTG_SESS_007', 'OTG_SESS_008', 'OTG_INPVAL_001',
                                      'OTG_INPVAL_002', 'OTG_INPVAL_003', 'OTG_INPVAL_004', 'OTG_INPVAL_005',
                                      'OTG_INPVAL_006', 'OTG_INPVAL_007', 'OTG_INPVAL_008', 'OTG_INPVAL_009',
                                      'OTG_INPVAL_010', 'OTG_INPVAL_011', 'OTG_INPVAL_012', 'OTG_INPVAL_013',
                                      'OTG_INPVAL_014', 'OTG_INPVAL_015', 'OTG_INPVAL_016', 'OTG_ERR_001',
                                      'OTG_ERR_002', 'OTG_CRYPST_001', 'OTG_CRYPST_002', 'OTG_CRYPST_003',
                                      'OTG_BUSLOGIC_001', 'OTG_BUSLOGIC_002', 'OTG_BUSLOGIC_003', 'OTG_BUSLOGIC_004',
                                      'OTG_BUSLOGIC_005', 'OTG_BUSLOGIC_006', 'OTG_BUSLOGIC_007', 'OTG_BUSLOGIC_008',
                                      'OTG_BUSLOGIC_009', 'OTG_CLIENT_001', 'OTG_CLIENT_002', 'OTG_CLIENT_003',
                                      'OTG_CLIENT_004', 'OTG_CLIENT_005', 'OTG_CLIENT_006', 'OTG_CLIENT_007',
                                      'OTG_CLIENT_008', 'OTG_CLIENT_009', 'OTG_CLIENT_010', 'OTG_CLIENT_011',
                                      'OTG_CLIENT_012', name='owaspcategory'), nullable=True),
                    sa.Column('tech_risk', sa.Enum('Info', 'Low', 'Medium', 'High', 'Critical', 'NA', name='score'),
                              nullable=False),
                    sa.Column('dissemination', sa.Enum('Info', 'Low', 'Medium', 'High', 'Critical', 'NA', name='score'),
                              nullable=False),
                    sa.Column('solution_complexity',
                              sa.Enum('Info', 'Low', 'Medium', 'High', 'Critical', 'NA', name='score'), nullable=False),
    ...
    op.create_table('assessment',
                    ...
                    sa.Column('type', sa.Enum('Web', 'External_pentest', 'Mobile', 'iOS', 'Android', 'WiFi',
                                              name='assessmenttype'), nullable=False),
    ...
    op.create_table('finding',
                    ...
                    sa.Column('title', sa.String(length=128), nullable=False),
                    sa.Column('status', sa.Enum('Pending', 'Reviewed', 'Confirmed', 'False_Positive', 'Other',
                                                name='findingstatus'), nullable=False),
                    sa.Column('owasp_category',
                              sa.Enum('OTG_INFO_001', 'OTG_INFO_002', 'OTG_INFO_003', 'OTG_INFO_004', 'OTG_INFO_005',
                                      'OTG_INFO_006', 'OTG_INFO_007', 'OTG_INFO_008', 'OTG_INFO_009', 'OTG_INFO_010',
                                      'OTG_CONFIG_001', 'OTG_CONFIG_002', 'OTG_CONFIG_003', 'OTG_CONFIG_004',
                    ...
                    sa.Column('tech_risk', sa.Enum('Info', 'Low', 'Medium', 'High', 'Critical', 'NA', name='score'),
                              nullable=False),
                    sa.Column('business_risk', sa.Enum('Info', 'Low', 'Medium', 'High', 'Critical', 'NA', name='score'),
                              nullable=True),
                    sa.Column('exploitability',
                              sa.Enum('Info', 'Low', 'Medium', 'High', 'Critical', 'NA', name='score'), nullable=True),
                    sa.Column('dissemination', sa.Enum('Info', 'Low', 'Medium', 'High', 'Critical', 'NA', name='score'),
                              nullable=False),
                    sa.Column('solution_complexity',
                              sa.Enum('Info', 'Low', 'Medium', 'High', 'Critical', 'NA', name='score'), nullable=False),
